...
module.exports = XeonBotInc = async (XeonBotInc, m, chatUpdate, store) => {
  try {
    ...
    async function replyprem(teks) {
      replygcxeon(
        `Fitur ini khusus premium, chat owner untuk menjadi user premium.`
      );
    }
    //script replier
    ...
    async function Telesticker(url) {
      return new Promise(async (resolve, reject) => {
        if (!url.match(/(https:\/\/t.me\/addstickers\/)/gi))
          return replygcxeon("Enther your url telegram sticker link");
    ...
    if (db.data.settings[botNumber].autobio) {
      XeonBotInc.updateProfileStatus(
    ...
    if (isGroup && db.data.chats[m.chat].antivirtex) {
      if (
        ...
        XeonBotInc.sendMessage(`${ownernumber}@s.whatsapp.net`, {
          text: `Hi Owner! wa.me/${
            sender.split("@")[0]
    ...
    if (db.data.chats[m.chat].antibot) {
      if (m.isBaileys && m.fromMe == false) {
        if (isAdmin || !isBotAdmin) {
          ...
          return await XeonBotInc.groupParticipantsUpdate(
            m.chat,
            [m.sender],
            "remove"
          );
    ...
    if (db.data.settings[botNumber].autosticker) {
      ...
      if (/image/.test(mime) && !/webp/.test(mime)) {
        ...
        XeonBotInc.sendImageAsSticker(from, mediac, m, {
          packname: global.packname,
          author: global.author,
        });
        ...
        let mediac = await quoted.download();
        XeonBotInc.sendVideoAsSticker(from, mediac, m, {
          packname: global.packname,
          author: global.author,
        });
      }
...
Type *surrender* to surrender and admit defeat`;
      ...
      if (room.x !== room.o)
        XeonBotInc.sendText(room.x, str, m, {
      ...
      case "addtitle":
        {
          if (!XeonTheCreator) return XeonStickOwner();
          if (!text)
            return replygcxeon(`Usage ${prefix + command} number|title`);
          nonya = text.split("|")[0];
      ...
      case "givelimit":
        {
          if (!XeonTheCreator) return XeonStickOwner();
          if (!text)
            return replygcxeon(`Usage ${prefix + command} number|limit amount`);
      ...
      case "dellimit":
        {
          ...
          if (db.data.users[usernya + "@s.whatsapp.net"].limit < limitnya)
            return replygcxeon(`His Limit Is Less Than ${limitnya}`);
      ...
      case "invite":
        {
          ...
          if (text.includes("+"))
            return replygcxeon(`Enter the number together without *+*`);
          if (isNaN(text))
            return replygcxeon(
          ...
          let link =
            ...
            (await XeonBotInc.groupInviteCode(group));
          await XeonBotInc.sendMessage(text + "@s.whatsapp.net", {
      ...
      case "searchnumber":
        {
          ...
          for (let i = 0; i < randomxx; i++) {
            ...
            var anu = await XeonBotInc.onWhatsApp(
      ...
      case "getcon":
        {
          ...
          xeonbigpp = await XeonBotInc.sendMessage(
            m.chat,
            {
      ...
      case "creategroup":
        {
          if (!XeonTheCreator) return XeonStickOwner();
          if (!args.join(" "))
            return replygcxeon(`Use ${prefix + command} groupname`);
          try {
...
https://chat.whatsapp.com/${response}`;
            XeonBotInc.sendMessage(
              m.chat,
              { text: teksop, mentions: await XeonBotInc.parseMention(teksop) },
              { quoted: m }
            );
          } catch {
            replygcxeon(`Error`);
      ...
      case "totag":
        ...
        if (!isAdmins) return replygcxeon(mess.admin);
        if (!m.quoted)
          return replygcxeon(`Reply media with caption ${prefix + command}`);
        XeonBotInc.sendMessage(m.chat, {
      ...
      case "grup":
        ...
        if (!isBotAdmins) return XeonStickBotAdmin();
        if (args[0] === "close") {
          await XeonBotInc.groupSettingUpdate(m.chat, "announcement").then(
            (res) => replygcxeon(`Success Closing Group`)
          );
        } else if (args[0] === "open") {
          await XeonBotInc.groupSettingUpdate(m.chat, "not_announcement").then(
            (res) => replygcxeon(`Success Opening Group`)
          );
        } else {
          replygcxeon(
      ...
      case "editinfo":
        ...
        if (!isBotAdmins) return XeonStickBotAdmin();
        if (args[0] === "open") {
          await XeonBotInc.groupSettingUpdate(m.chat, "unlocked").then((res) =>
            replygcxeon(`Successfully Opened Edit Group Info`)
          );
        } else if (args[0] === "close") {
          await XeonBotInc.groupSettingUpdate(m.chat, "locked").then((res) =>
            replygcxeon(`Successfully Closed Edit Group Info`)
          );
        } else {
...
`;
      ...
      case "resetlink":
        ...
        if (!isAdmins && !isGroupOwner && !XeonTheCreator)
          return XeonStickAdmin();
        if (!isBotAdmins) return XeonStickBotAdmin();
        await XeonBotInc.groupRevokeInvite(m.chat).then((res) => {
...
${themeemoji} URL: ${repoData.html_url}
 ...
 `.trim();
      ...
      case "volaudio":
        {
          if (!args.join(" "))
            return replygcxeon(`Example: ${prefix + command} 10`);
      ...
      case "tictactoe":
        {
          ...
          if (
            ...
            return replygcxeon("You are still in the game");
          let room = Object.values(this.game).find(
            (room) =>
      ...
      case "suit":
        {
          ...
          if (
            ...
            replygcxeon(`Finish your previous suit`);
          if (m.mentionedJid[0] === m.sender)
            return replygcxeon(`Can't play with myself !`);
          if (!m.mentionedJid[0])
            return replygcxeon(
...
Please @${m.mentionedJid[0].split`@`[0]} to type accept/reject`;
          this.suit[id] = {
            ...
            waktu: setTimeout(() => {
              if (this.suit[id])
                XeonBotInc.sendText(m.chat, `_Suit time is up_`, m);
              delete this.suit[id];
            }, 60000),
            poin,
            poin_lose,
      ...
      case "math":
        {
          if (kuismath.hasOwnProperty(m.sender.split("@")[0]))
            replygcxeon(`There are still unfinished sessions!`);
      ...
      case "openai":
        {
          ...
          if (!q)
            return replygcxeon(`Example : ${prefix + command} who is ronaldo`);
            ...
            messages: [
              {
                ...
                from: {
                  ...
                  name: pushname,
                  photo: {
                    url: await XeonBotInc.profilePictureUrl(
                      m.sender,
                      "image"
                    ).catch(
                      () =>
      ...
      case "addvideo":
        {
          ...
          if (VideoXeon.includes(q))
            return replygcxeon("The name is already in use");
          let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted);
          VideoXeon.push(q);
          await fsx.copy(delb, `./XeonMedia/video/${q}.mp4`);
          fs.writeFileSync(
            "./XeonMedia/database/xeonvideo.json",
      ...
      case "delvideo":
        {
          ...
          if (!VideoXeon.includes(q))
            return replygcxeon("The name does not exist in the database");
      ...
      case "addimage":
        {
          ...
          fs.writeFileSync(
            "./XeonMedia/database/xeonimage.json",
      ...
      case "addsticker":
        {
          ...
          fs.writeFileSync(
            "./XeonMedia/database/xeonsticker.json",
      ...
      case "addmsg":
        {
          if (!XeonTheCreator) return XeonStickOwner();
          if (!m.quoted)
            return replygcxeon("Reply Message You Want To Save In Database");
          if (!text)
            return replygcxeon(`Example : ${prefix + command} filename`);
          let msgs = global.db.data.database;
          if (text.toLowerCase() in msgs)
            return replygcxeon(`'${text}' registered in the message list`);
      ...
      case "getmsg":
        {
          ...
          let msgs = global.db.data.database;
          if (!(text.toLowerCase() in msgs))
            return replygcxeon(`'${text}' not listed in the message list`);
      ...
      case "addvn":
        {
          ...
          fs.writeFileSync(
            "./XeonMedia/database/xeonvn.json",
      ...
      case "tiktok":
        {
          ...
          require("./lib/tiktok")
            ...
            .then((data) => {
              XeonBotInc.sendMessage(
                m.chat,
                { caption: `Here you go!`, video: { url: data.nowm } },
                { quoted: m }
              );
            });
        }
...
Nickname : ${eeh.nickname}`);
      ...
      case "mlstalk":
        {
          if (!q)
            return replygcxeon(`Example ${prefix + command} 530793138|8129`);
          await XeonStickWait();
...
ID Zone: ${q.split("|")[1]}`);
      ...
      case "happymod":
        {
          if (!q)
            return replygcxeon(`Example ${prefix + command} Sufway surfer mod`);
          await XeonStickWait();
...
▢ *Type:* ${res.mimetype}`);
      ...
      case "ringtone":
        {
          if (!text)
            return replygcxeon(`Example : ${prefix + command} black rover`);
...
*${themeemoji} Example:* ${targetfine.data.list[0].example
      ...
      case "rate":
        {
          if (!text)
            return replygcxeon(`Example : ${prefix + command} my profile`);
          let ra = [
            "1",
            "2",
            "3",
      ...
      case "handhold":
        {
          axios
            ...
            .then(({ data }) => {
              XeonBotInc.sendImageAsSticker(from, data.url, m, {
                packname: global.packname,
                author: global.author,
              });
            });
...
*≡═══《 CHECK PROPERTIES 》═══≡*`;
      ...
      case "shinetext":
        {
          if (!q)
            return replygcxeon(`Example : ${prefix + command} XeonBotInc`);
          await XeonStickWait();
      ...
      case "lockcmd":
        {
          ...
          if (!(hash in global.db.data.sticker))
            return replygcxeon("Hash not found in database");
...
${translatedTafsirEnglish.text}`;
      ...
      case "mediafire":
        {
          if (!args[0])
            return replygcxeon(`Enter the mediafire link next to the command`);
          if (!args[0].match(/mediafire/gi))
            return replygcxeon(`Link incorrect`);
      ...
      case "blurimg":
        {
          ...
          XeonBotInc.sendMessage(
            m.chat,
            {
              image: { url: `https://vihangayt.me/maker/blur?url=${anu}` },
              caption: "Here you go!",
            },
            { quoted: m }
          );
      ...
      case "beautifulimg":
        {
          ...
          XeonBotInc.sendMessage(
            m.chat,
            {
              image: { url: `https://vihangayt.me/maker/beautiful?url=${anu}` },
              caption: "Here you go!",
            },
            { quoted: m }
          );
      ...
      case "facepalmimage":
        {
          ...
          XeonBotInc.sendMessage(
            m.chat,
            {
              image: { url: `https://vihangayt.me/maker/facepalm?url=${anu}` },
              caption: "Here you go!",
            },
            { quoted: m }
          );
      ...
      case "invertimage":
        {
          ...
          XeonBotInc.sendMessage(
            m.chat,
            {
              image: { url: `https://vihangayt.me/maker/invert?url=${anu}` },
              caption: "Here you go!",
            },
            { quoted: m }
          );
      ...
      case "pixelateimage":
        {
          ...
          XeonBotInc.sendMessage(
            m.chat,
            {
              image: { url: `https://vihangayt.me/maker/pixelate?url=${anu}` },
              caption: "Here you go!",
            },
            { quoted: m }
          );
      ...
      case "rainbowimage":
        {
          ...
          XeonBotInc.sendMessage(
            m.chat,
            {
              image: { url: `https://vihangayt.me/maker/rainbow?url=${anu}` },
              caption: "Here you go!",
            },
            { quoted: m }
          );
      ...
      case "wantedimage":
        {
          ...
          XeonBotInc.sendMessage(
            m.chat,
            {
              image: { url: `https://vihangayt.me/maker/wanted?url=${anu}` },
              caption: "Here you go!",
            },
            { quoted: m }
          );
      ...
      case "wastedimage":
        {
          ...
          XeonBotInc.sendMessage(
            m.chat,
            {
              image: { url: `https://vihangayt.me/maker/wasted?url=${anu}` },
              caption: "Here you go!",
            },
            { quoted: m }
          );
      ...
      case "enhance":
        {
          ...
          XeonBotInc.sendMessage(
            m.chat,
            {
              image: { url: `https://vihangayt.me/tools/enhance?url=${anu}` },
              caption: "Here you go!",
            },
            { quoted: m }
          );
      ...
      case "dehaze":
        {
          ...
          XeonBotInc.sendMessage(
            m.chat,
            {
              image: { url: `https://vihangayt.me/tools/dehaze?url=${anu}` },
              caption: "Here you go!",
            },
            { quoted: m }
          );
      ...
      case "trollybug":
        {
          ...
          for (let i = 0; i < amount; i++) {
            ...
            XeonBotInc.relayMessage(victim, order.message, {
      ...
      case "trollygcbug":
        {
          ...
          for (let i = 0; i < amount; i++) {
            ...
            XeonBotInc.relayMessage(xeongc, order.message, {
              messageId: order.key.id,
            });
          }
          replygcxeon(
